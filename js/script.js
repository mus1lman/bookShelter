...
// Function to turn off body scrolling
const scrollBody = () => {
...
// function for modal disappearance
window.onclick = (evt) => {
...
// Search function to search from input
